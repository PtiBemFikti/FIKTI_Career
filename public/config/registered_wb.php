...
<body>
    ...
    <!-- batch 1 -->
    <!--<img src="../../assets/img/barcode_wb1.jpg" alt="Nature" class="responsive" width="300" height="300">-->
    <!-- batch 2 -->
     <img src="/assets/img/barcode_wb2.jpg" alt="Nature" class="responsive" width="300" height="300"> 

    <!-- batch 1 -->
    <!--<p><b><a style="color: green;" href="https://chat.whatsapp.com/J9FXLYfbdxSBMZNVYWxCrW">Klik link ini untuk join grup</a></b></p>-->
    <!-- batch 2 -->
     <p><b><a style="color: green;" href="https://chat.whatsapp.com/F4VMSlKUhMs7FDHTxR9kc0">Klik link ini untuk join grup</a></b></p> 
